...
while($row = mysqli_fetch_assoc($result)) { ?>
    <tr> 
      ...
      <a href="adminproizvod.php?delete=<?php echo $row['ID'] ?>" class="btn btn-danger" onclick="return confirm('Да ли хоћеш да избришеш овај производ?')"><i class="fa fa-trash-alt"></i></a></td>
    </tr>
    <?php } ?>
  </tbody>
</table>
