...
$adresa = $_POST['adresa'];
	if(!isset($errorMsg)){
		$sql = "insert into kupac(Korisnicko_ime, Lozinka, Ime, Prezime, Telefon, Email, Grad, Post_broj, Adresa)
				values('".$kor_ime."', '".$lozinka."', '".$ime."', '".$prezime."', '".$telefon."', '".$email."', '".$grad."', '".$post_broj."', '".$adresa."')";
