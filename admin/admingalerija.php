      ...
      <tbody>
        ...
        while($row = mysqli_fetch_array($result)) {
          echo "<tr>";
            ...
            ?>
            <td>
              <a href="galvidi.php?id=<?php echo $row['ID'] ?>" class="btn btn-success"><i class="fa fa-eye"></i></a>
              <a href="galizmeni.php?id=<?php echo $row['ID'] ?>" class="btn btn-info"><i class="fa fa-user-edit"></i></a>
              <a href="admingalerija.php?delete=<?php echo $row['ID'] ?>" class="btn btn-danger" onclick="return confirm('Да ли хоћеш да избришеш ову слику?')"><i class="fa fa-trash-alt"></i></a>
            </td>
          </tr>
        <?php } ?>
      </tbody>
