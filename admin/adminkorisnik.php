    ...
    <table class="table table-striped table-bordered table-hover table-sm" id="tabela">
      ...
      <tbody>
        ...
        while($row = mysqli_fetch_array($result)) {
          ...
          <td>
            <a href="korvidi.php?id=<?php echo $row['ID'] ?>" class="btn btn-success"><i class="fa fa-eye"></i></a>
            <a href="korizmeni.php?id=<?php echo $row['ID'] ?>" class="btn btn-info"><i class="fa fa-user-edit"></i></a>
            <a href="adminkorisnik.php?delete=<?php echo $row['ID'] ?>" class="btn btn-danger" onclick="return confirm('Да ли хоћеш да избришеш овог корисника?')"><i class="fa fa-trash-alt"></i></a>
          </td>
        <?php echo "</tr>";
        }
        ?>
